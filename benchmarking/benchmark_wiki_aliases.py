...
def train_aliases(input_tuple):
  ...
  best_model_path=lt.train_model(
            ...
            training_args = {"num_epochs":n,"model_save_name":save_name,"save_val_test_pickles":True,
                              ...
                              The model was trained for {n} epochs using other defaults that can be found in the repo's LinkTransformer config file - LT_training_config. \n \ ",
                              "opt_model_lang":lang,
                             },
            log_wandb=True
                    )
  ...
  best_model.save_to_hub(repo_name = "linkage_en_aliases", ##Write model name here
...
if __name__ == "__main__":
  train_inputs = [
        ("en_aliases.json", "multi-qa-mpnet-base-dot-v1",50,"linkage_en_aliases" ),
        ("es_aliases.json","hiiamsid/sentence_similarity_spanish_es",50,"linkage_es_aliases"),
        ("fr_aliases.json", "dangvantuan/sentence-camembert-large",50,"linkage_fr_aliases"),
      ("ja_aliases.json", "oshizo/sbert-jsnli-luke-japanese-base-lite", 50,"linkage_ja_aliases"),
      ("zh_aliases.json", "DMetaSoul/sbert-chinese-qmc-domain-v1", 50,"linkage_zh_aliases"),
      ("de_aliases.json", "T-Systems-onsite/cross-en-de-roberta-sentence-transformer", 50,"linkage_de_aliases")
      ]
